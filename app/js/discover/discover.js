...
.controller('DiscoverCtrl', ['Comics', '$scope', '$mdToast', '$filter', 'imageVariants',
    function(Comics, $scope, $mdToast, $filter, imageVariants) {
        var vm = this;
        ...
        vm.submit = function(){
            if($scope.frm.$valid){
                ...
                Comics.get({dateRange: vm.getDateRange(vm.birthYear)},
                    function(response){ vm.flags.loading = false; vm.setComics(response); },
